...
return [
    ...
    "about" => [
        ...
        "3" => [
            "1" => "L'entièreté du projet RedCraft.org est développé avec des outils modernes dans l'objectif d'avoir une infrastructure flexible, tout en étant open source. Retrouvez toutes les sources sur notre page ",
            "2" => "GitHub",
            "3" => " !",
        ],
        "4" => [
    ...
    "faq" => [
        "title" => "FAQ",
        "1" => [
            "title" => "Qu'est-ce que RedCraft.org ?",
            "description" => "RedCraft.org est une infrastructure de serveurs Minecraft multilingue. Le projet rassemble plusieurs serveurs créatifs ou survie, le tout étant complètement open source !",
        ],
        "2" => [
            "title" => "Comment fonctionne le projet ?",
            "description" => [
